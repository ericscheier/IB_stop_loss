...
#! [socket_init]
    ...
    #! [stoploss]
    def stoploss(self):
        fluctuation_limit = 0.01 #0.01
        fluctuation = 0.00
        if self.account_value!=0 and self.unrealizedpnl!=0:
            fluctuation = abs((self.account_value - self.unrealizedpnl)/self.account_value)
        print("Fluctiation: ",fluctuation)
        if fluctuation >= fluctuation_limit:
            print("Fluctuation >= Limit, closing all positions")
        print("Test")
    #! [stoploss]
